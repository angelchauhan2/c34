...
function draw() 
{
  ...
  drawSprites();
//condition for changing animation to eating
...
//condition to change animation to crying
...
//function to take place ones the rope cuts
function drop()
{
  cut_sound.play();
  rope.break();
